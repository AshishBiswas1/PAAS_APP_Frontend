    ...
    <section className="mx-auto max-w-md px-6 py-16">
      ...
      <form className="space-y-4 bg-card-glass p-6 rounded-lg">
        <label className="block">
          ...
          <input type="text" className="w-full px-3 py-2 rounded-md border border-neutral-200 dark:border-neutral-800 bg-white/60 dark:bg-transparent" placeholder="Your name" />
        </label>
        <label className="block">
        ...
        <button type="submit" className="w-full inline-flex justify-center rounded-md bg-brand-600 text-white px-4 py-2">Create account</button>
      </form>
    </section>
  );
}
